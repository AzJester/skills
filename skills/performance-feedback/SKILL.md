...
Close to the event. Feedback three months later is about a fading memory and reads as ambush, particularly in a review.
...
Their meeting, not your status update. If the recurring one-to-one is where you collect progress, you have replaced it with a standup and lost the thing it was for.

A shape that works:

- **Their agenda first.** What is on their mind, what is blocked, what they want to discuss.
...
**Nothing in a review should be new.** A surprise in a review is a failure of the preceding months, not a finding.

- **Evidence, not adjectives.** "Delivered the integration two weeks early despite the vendor delay, and wrote the runbook the on-call team now uses" beats "strong performer".
- **Whole period, not the last six weeks.** Recency is the dominant bias in review writing. Notes from your one-to-ones are the corrective.
- **Their contribution, distinguished from the team's.** Particularly for people on successful teams and people on struggling ones.
- **Specific development direction.** "Improve communication" gives nobody anything. "Take the architecture review for the next release, and prepare it with me the week before" is actionable.
- **Where you were unable to observe**, say so rather than filling the space.

## Performance problems

When performance is genuinely below the bar, the kindest thing is clarity, early.

- **Say it plainly.** People routinely leave these conversations unaware they were the subject of one. If the person cannot afterwards state what was wrong and what must change, it did not land.
- **Name the gap against a standard**, not against another person.
- **Be explicit about consequence.** What happens if it does not change. Ambiguity here is not kindness; it removes the person's ability to make an informed decision about their own situation.
- **Agree what changes, by when, and what success looks like**, in writing, shared with them.
...
Half the skill, and the half that determines whether people keep giving it to you.

Listen without defending. Ask for the specific example. Say what you will do. Come back later and say what happened — that last step is what makes people willing to tell you difficult things again.

If you visibly argue with feedback, you will stop receiving it, and you will not be told that either.
