...
fx          list of effect tokens, matched by name in render.py's background/panel helpers
...
STYLES = {
    ...
    "aqua": dict(
        ...
        radius=14, stroke_w=1, dash="", fx=["gloss", "shadow", "traffic"],
        title_fx="plain"),
    "dark-neon": dict(
    ...
    "stained-glass": dict(
        ...
        fx=["leading", "glow"], title_fx="banner"),
    "noir": dict(
        ...
        dash="", fx=["blinds", "vignette"], title_fx="banner"),
    ...
    "comic": dict(
        ...
        radius=10, stroke_w=4, dash="", fx=["benday", "sketch"], title_fx="banner"),
    "brutalist": dict(
    ...
    "ghibli": dict(
        ...
        fx=["sketch", "noise", "clouds"], title_fx="banner"),
    "kawaii": dict(
        ...
        stroke_w=2, dash="", fx=["sparkle", "blush", "shadow"], title_fx="plain"),
    ...
    "baroque": dict(
        ...
        fx=["filigree", "noise", "vignette"], title_fx="banner"),
    ...
    "vaporwave": dict(
        ...
        dash="", fx=["horizon", "glow", "sparkle"], title_fx="banner"),
    "synthwave": dict(
        ...
        fx=["horizon", "grid", "glow"], title_fx="banner"),
    "memphis": dict(
    ...
    "cubist": dict(
        ...
        fx=["facets", "skew"], title_fx="banner"),
    "surrealist": dict(
        ...
        fx=["checker_floor", "melt", "eyes", "vignette"], title_fx="banner"),
}
